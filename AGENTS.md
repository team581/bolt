...
- Bolt has no staging or development instance. Local Junior runtime commands use whichever external services are configured, which are production services in the normal project setup; do not assume local CLI runs are isolated from production.
